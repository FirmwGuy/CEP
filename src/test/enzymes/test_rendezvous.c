/* Rendezvous tests are temporarily disabled while the kernel bootstrap
 * migrates to the heartbeat init/shutdown impulse flow. Keeping explicit
 * skip stubs maintains the suite structure without incurring watchdog time. */
